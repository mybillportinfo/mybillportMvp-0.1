...
function buildWelcomeEmail(name: string) {
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <div style="background: linear-gradient(135deg, #3d5a8f 0%, #059669 100%); color: white; padding: 30px; text-align: center;">
      ...
      <div style="padding: 30px; background: white;">
        ...
        <div style="background: #f0fdf4; border-left: 4px solid #FFB347; padding: 20px; margin: 25px 0; border-radius: 0 8px 8px 0;">
      ...
      <div style="background: #f3f4f6; padding: 20px; text-align: center; font-size: 12px; color: #6b7280;">
        ...
        <p style="margin: 0;">
          <a href="https://mybillport.com" style="color: #3d5a8f; text-decoration: none;">mybillport.com</a>
        </p>
      </div>
    </div>
  `;

...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#0b1426] text-white" style={{ fontFamily: "system-ui, -apple-system, BlinkMacSystemFont, sans-serif" }}>
      <FAQJsonLd />
      <SoftwareApplicationJsonLd />

      <header className="sticky top-0 z-50 bg-[#0b1426]/95 backdrop-blur-md border-b border-white/5">
        <div className="max-w-5xl mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <Link href="/login" className="bg-[#FF8A5C] hover:bg-[#e5753d] text-white font-semibold text-sm px-5 py-2.5 rounded-full transition-colors flex items-center gap-1.5">
              Get started free
          </Link>
        </div>
      </header>
      ...
      <section className="pt-20 pb-24 px-5 text-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-radial from-[#FF8A5C]/10 via-transparent to-transparent pointer-events-none" />
        <div className="max-w-3xl mx-auto relative space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <Link href="/login" className="bg-[#FF8A5C] hover:bg-[#e5753d] text-white font-bold px-8 py-4 rounded-full transition-colors flex items-center gap-2 text-base shadow-lg shadow-[#FF8A5C]/20">
        ...
        <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-6 md:gap-12 text-sm text-slate-500">
          {["120+ billers supported", "AI-powered bill scanning", "256-bit encryption", "Available worldwide"].map((t) => (
            <div key={t} className="flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-[#2AC3B5] flex-shrink-0" />
              <span>{t}</span>
            </div>
          ))}
        </div>
      ...
      <div className="max-w-5xl mx-auto px-5 space-y-28 py-24">
        ...
        <section id="features" className="scroll-mt-20 space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <p className="text-[#FF8A5C] text-sm font-semibold uppercase tracking-wider">Features</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={f.title} className="bg-[#111d33] border border-white/5 rounded-2xl p-6 space-y-4 hover:border-[#FF8A5C]/20 transition-colors group">
                <div className="w-10 h-10 bg-[#FF8A5C]/10 group-hover:bg-[#FF8A5C]/20 rounded-xl flex items-center justify-center transition-colors">
        ...
        <section className="bg-gradient-to-br from-[#FF8A5C]/10 to-[#2AC3B5]/10 border border-[#FF8A5C]/15 rounded-3xl p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 bg-[#C4E538]/10 border border-[#C4E538]/20 text-[#C4E538] text-xs font-semibold px-3 py-1 rounded-full">
            ...
            <div className="bg-[#111d33] border border-white/10 rounded-2xl p-5 space-y-3">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-[#FF8A5C]/20 rounded-lg flex items-center justify-center">
                  <Sparkles className="w-4 h-4 text-[#FF8A5C]" />
                </div>
              ...
              <div className="bg-[#FF8A5C]/10 rounded-xl px-4 py-3 text-sm text-slate-300 max-w-[85%] ml-auto">
        ...
        <section id="how" className="scroll-mt-20 space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <p className="text-[#2AC3B5] text-sm font-semibold uppercase tracking-wider">How it works</p>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={s.step} className="relative bg-[#111d33] border border-white/5 rounded-2xl p-7 space-y-4">
                <span className="text-5xl font-black text-[#FF8A5C]/15 leading-none block">{s.step}</span>
        ...
        <section id="pricing" className="scroll-mt-20 space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <p className="text-[#FF8A5C] text-sm font-semibold uppercase tracking-wider">Pricing</p>
          ...
          <div className="grid sm:grid-cols-3 gap-5 items-start">
            <div className="bg-[#111d33] border border-white/5 rounded-2xl p-7 space-y-5">
              <div>
              ...
              <Link href="/login" className="block w-full border border-[#FF8A5C]/40 text-[#FF8A5C] hover:bg-[#FF8A5C]/10 font-semibold py-3 rounded-full transition-colors text-sm text-center">
                  Get started free
              </Link>
            </div>

            <div className="bg-[#111d33] border-2 border-[#FF8A5C]/50 rounded-2xl p-7 space-y-5 relative shadow-[0_0_30px_rgba(255,138,92,0.08)]">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#FF8A5C] text-white text-xs font-bold px-3 py-1 rounded-full">
                Most popular
              </div>
              <div>
                <p className="text-sm font-semibold text-[#FF8A5C] mb-1">Pro</p>
              ...
              <button disabled className="w-full bg-[#FF8A5C]/30 text-[#FF8A5C] font-semibold py-3 rounded-full text-sm cursor-not-allowed opacity-70">
                Coming soon
              </button>
            </div>
      ...
      <div className="max-w-5xl mx-auto px-5 py-24">
        <section className="bg-gradient-to-br from-[#FF8A5C]/15 to-[#2AC3B5]/10 border border-[#FF8A5C]/15 rounded-3xl p-10 md:p-16 text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Your bills aren't going anywhere.<br />
            <span className="text-[#FF8A5C]">Your stress can.</span>
          </h2>
          ...
          <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-xs text-slate-500">
              <span className="flex items-center gap-1.5">
                <ShieldCheck className="w-3.5 h-3.5 text-[#2AC3B5]" />
                256-bit encrypted
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle className="w-3.5 h-3.5 text-[#2AC3B5]" />
                SOC 2 practices
              </span>
            </div>
          </div>

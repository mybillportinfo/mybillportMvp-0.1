...
export const metadata: Metadata = {
  title: 'Bill Management App — Track & Pay All Your Bills',
  description: 'The easiest way to manage bills. Track due dates, get reminders, and pay 120+ billers from one dashboard. AI-powered bill scanning included. Free to start.',
  alternates: {
    canonical: 'https://mybillport.com/bill-management-canada',
  },
  openGraph: {
    title: 'Bill Management App — MyBillPort',
    description: 'Track due dates, get smart reminders, and pay 120+ billers from one dashboard.',
      ...
      <div className="max-w-4xl mx-auto px-5 py-16 space-y-16">
        ...
        <section className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { icon: Camera, title: 'AI Bill Scanning', desc: 'Snap a photo of any bill and our AI extracts the details instantly.' },
              { icon: Bell, title: 'Smart Reminders', desc: 'Get notified before every due date — by push notification, right on your phone.' },
              { icon: Zap, title: 'One-Click Payments', desc: 'Direct links to 120+ billers so you can pay in seconds.' },
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-white">120+ billers supported</h2>
          <p className="text-slate-400">
            From major telecom providers to local utilities, MyBillPort supports billers across multiple regions and is expanding globally.
          </p>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            {[
              { step: '1', title: 'Add your bills', desc: 'Upload a photo/PDF or add manually. Our AI reads bill formats and extracts the details.' },
              { step: '2', title: 'Get smart reminders', desc: 'Receive push notifications 7 days, 2 days, and the day each bill is due.' },
              { step: '3', title: 'Pay with one click', desc: 'Click Pay to go directly to your biller\'s official payment portal.' },
            ].map((s) => (

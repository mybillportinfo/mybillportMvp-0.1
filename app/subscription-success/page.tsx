    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-800 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl p-8 max-w-sm w-full text-center space-y-5">
        <div className="w-16 h-16 bg-[#4D6A9F]/15 rounded-full flex items-center justify-center mx-auto">
          <CheckCircle className="w-9 h-9 text-[#4D6A9F]" />
        </div>
        <div>
        ...
        <div className="space-y-3">
          <Link href="/app" className="flex items-center justify-center gap-2 w-full py-3 bg-[#4D6A9F] text-white rounded-xl font-semibold hover:bg-[#3d5a8f] transition-colors">

...
// Validate ../../../app/api/stripe-key/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/stripe-key">> = Specific
  const handler = {} as typeof import("../../../app/api/stripe-key/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
